...
<div class="col-lg-12">
	<div class="d-flex w-100 justify-content-center align-items-center mb-2">
		<label for="" class="control-label">Find Test</label>
				...
				<div class="card-body" style="display: block;">
					...
					<div class="row">
						...
						<div class="d-flex justify-content-center w-100 text-center">
							<div class="btn-group">
								<a href="index.php?page=view_test_takers&id=<?php echo $row['id'] ?>"
									class="btn btn-sm bg-gradient-primary m-3"><i class="fa fa-poll"></i>
									Test Takers</a>
							</div>
							<div class="btn-group">
								<a href="index.php?page=view_test_report&id=<?php echo $row['id'] ?>"
									class="btn btn-sm bg-gradient-primary m-3"><i class="fa fa-poll"></i> View
									Report</a>
							</div>
						</div>
					</div>
