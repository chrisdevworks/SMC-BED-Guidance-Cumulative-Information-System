...
<div class="col-lg-12">
	...
	<div class="row">
		<?php 
		$now = date('Y-m-d');
		$survey = $conn->query("SELECT * FROM survey_set where '".$now."' between date(start_date) and date(end_date) order by rand() ");
               ...
               <div class="row">
               	...
               	<div class="d-flex justify-content-center w-100 text-center">
               		<?php if(!isset($ans[$row['id']])): ?>
               			<a href="index.php?page=answer_test&id=<?php echo $row['id'] ?>" class="btn btn-sm bg-gradient-primary"><i class="fa fa-pen-square"></i> Take Test</a>
               		<?php else: ?>
