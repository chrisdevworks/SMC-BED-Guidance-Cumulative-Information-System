	...
	<div class="row">
		...
		<div class="col-md-8">
			<div class="card card-outline card-success">
				<div class="card-header">
					<h3 class="card-title"><b>Test Questionaire</b></h3>
				...
				<div class="card-body ui-sortable">
					...
					// $question = $conn->query("SELECT * FROM questions where survey_id = ".$_GET['id']." AND A.user_id = ".$_GET['users']." ORDER by abs(order_by) asc,abs(id) asc");
					...
					<div class="callout callout-info">
							...
							<div class="col-md-12">	
								<span class="dropleft float-right">
									...
									<div class="dropdown-menu">
								        <a class="dropdown-item edit_question text-dark" href="javascript:void(0)" data-id="<?php echo $row['Q.id'] ?>">Edit</a>
								        <div class="dropdown-divider"></div>
								        <a class="dropdown-item delete_question text-dark" href="javascript:void(0)" data-id="<?php echo $row['Q,id'] ?>">Delete</a>
								     </div>
								</span>	
							</div>	
						</div>	
						...
						<input type="hidden" name="qid[]" value="<?php echo $row['id'] ?>">	
							...
							<div class="icheck-primary">
								...
								<?php endforeach; ?>
						<?php elseif($row['Q_type'] == 'check_opt'): 
									foreach(json_decode($row['frm_option']) as $k => $v):
							?>
							<div class="icheck-primary">
