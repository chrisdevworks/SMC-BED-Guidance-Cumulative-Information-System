...
<?php if($_SESSION['login_type'] == 1): ?>
  ...
  <?php else: ?>
      ...
      <div class="row">
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              <span class="info-box-icon bg-primary elevation-1" style="cursor: pointer;"><i class="fas fa-poll-h" onmouseenter="this.classList.add('fa-beat')" onmouseout="this.classList.remove('fa-beat')"></i></span>

              <div class="info-box-content">
                <span class="info-box-text">Total Test Taken</span>
                <span class="info-box-number">
